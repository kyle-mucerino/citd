...
import tourPoster from "./assets/SummerTourPoster.jpg";
    ...
    <>
      ...
      <div className="bg-black">
        ...
        <div className="flex flex-col p-2 items-center space-y-12 sm:space-y-0">
          <button className="p-2 pb-4 bg-white text-black rounded-lg text-xl custom:text-4xl font-bold uppercase hover:scale-105 transition-transform duration-300 text-center">
            <a
